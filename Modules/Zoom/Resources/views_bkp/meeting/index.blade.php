...
@section('page-title')
    <x-main-header>
        ...
        <x-slot name="btns">
            <x-link type="modal" modalId="#my-meeting" classes="btn btn-cs-blue" icon="ti-plus" title="zoom::modules.zoommeeting.addMeeting"/>
            {{-- <x-link classes="btn btn-cs-green" icon="fa fa-calendar" url="{{route('admin.offmeeting.calendar')}}" title="zoom::modules.zoommeeting.calendarView"/> --}}
        </x-slot>
    </x-main-header>
@endsection
...
{{--                            </div>--}}
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <label class="control-label">Room&nbsp;<a href="javascript:;" id="addCategory" class="btn btn-xs btn-success btn-outline"><i class="fa fa-plus"></i></a></label>
                                    <select class="select2 form-control" data-placeholder="Room" id="room_id" name="room">
    ...
    <script>
        ...
        $(function() {
            $('body').on('click', '.sa-params', function () {
                ...
                swal({
                    ...
                    if (isConfirm == 'confirm' || isConfirm == 'recurring') {
                        ...
                        var url = "{{ route('admin.offmeeting.destroy',':id') }}";
            ...
            $('body').on('click', '.cancel-meeting', function(){
                ...
                swal({
                    ...
                    if (isConfirm == 'confirm') {
                        ...
                        var url = "{{ route('admin.offmeeting.cancelMeeting') }}";
            ...
            $('body').on('click', '.btnedit', function() {
                ...
                var id = $(this).data('id');
                var url = "{{ route('admin.offmeeting.edit', ':id')}}";
                url = url.replace(':id', id);
                $('#modelHeading').html('');
