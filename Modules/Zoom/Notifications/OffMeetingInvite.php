...
class OffMeetingInvite extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        ...
        $vEvent
            ...
            ->setNoTime(true)
            ->setSummary(ucfirst($this->meeting->title));
        ...
        return (new MailMessage)
            ...
            ->line(__('zoom::modules.zoommeeting.meetingName') . ': ' . $this->meeting->title)
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'meeting_name' => $this->meeting->title
        ];
    }
}
