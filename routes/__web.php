...
Route::get('email-check', 'RegisterController@checkEmail')->name('front.emailcheck');
Route::get('success', '\App\Http\Controllers\Front\RegisterController@showSuccess');
Route::get('cancelAccount', '\App\Http\Controllers\Admin\AdminBillingController@cancelAccount');

Route::get('terms', function () {
    echo "Tersm and Conditions page";
})->name('terms');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(
        ...
        function () {
            ...
            Route::post('/companies', ['uses' => 'SuperAdminCompanyController@store'])->name('companies.store');
            Route::post('/companies/{id}/login', 'SuperAdminCompanyController@loginAsCompany')->name('companies.loginAsCompany');
            Route::get('/companies/create-2', 'SuperAdminCompanyController@create2')->name('companies.create2');
            ...
            Route::group(
                ...
                function () {
                    ...
                    Route::resource('currency', 'SuperAdminCurrencySettingController');
                    Route::resource('tla', 'SuperAdminCompanyTLAController');
    ...
    Route::group(
        ...
        function () {
            ...
            Route::get('account-setup/edit-form', 'ManageAccountSetupController@edit_form')->name("account-setup.edit-form");
    ...
    Route::group(
        ...
        function () {
            ...
            Route::get('language/change', ['uses' => 'MemberProfileController@changeLanguageTwo'])->name('language.change');
    ...
    Route::group(
        ...
        function () {
            ...
            Route::get('language/change', ['uses' => 'ClientProfileController@changeLanguageTwo'])->name('language.change');
            // change company
