...
<div data-elementor-type="wp-page" data-elementor-id="36" class="elementor elementor-36"
    ...
    <div class="elementor-section-wrap">
        <section
                style="height: 100%; min-height : max-content"
            ...
            <div class="elementor-container elementor-column-gap-default" style="height: 100%">
                <div class="elementor-column elementor-col-60 elementor-top-column elementor-element elementor-element-3fb2d532 elementor-hidden-phone"
                    ...
                    <div class="elementor-widget-wrap elementor-element-populated" 
                        style="background: url({{asset('img/login-page-img.png')}}); background-repeat : no-repeat; background-size: cover; padding: 0;"
                    >
                        <section
                ...
                <div class="elementor-column elementor-col-40 elementor-top-column elementor-element elementor-element-49c0557e" style="background: #E5E5E5;"
                    ...
                    <div class="elementor-widget-wrap elementor-element-populated">
                        <div class="elementor-element elementor-element-4138c485 elementor-button-align-start elementor-widget elementor-widget-form"
                            ...
                            <div class="elementor-widget-container">
                                ...
                                <div class="elementor-widget-container text-center" style="height: 100%; margin-bottom: 100px">
                                ...
                                <span id="step1" style="display: block;" >
                                        <div class="elementor-heading-title elementor-field-type-html text-center elementor-field-group elementor-column elementor-field-group-name elementor-col-100">
...
<option @if(old('activity_field')=='Écriture/Édition') selected @endif value="Écriture/Édition">Écriture/Édition</option>
                                            ...
                                            <div class="elementor-field-subgroup">
                                                <span class="elementor-field-option">
                                                    <input type="checkbox" name="terms" id="terms"
                                                           ...
                                                           required>
                                                    <label style="background-color: transparent !important;" for="terms">
                                                        En cochant cette case, vous déclarez avoir lu nos <a href="{{route('terms')}}">Conditions Générales</a> et <a href="#">Ventes et d’Utilisations</a></label></span>
                                            </div>
                                        </div>
                                        {{-- <div
                                ...
                                <div
                                    ...
                                    <button type="button" class="btn btn-primary btn-lg btn-block "
                                            style="color:white;background-color:#00A2F2;margin-top: 40px; box-shadow:none;" id="next">
                                            <span>
...
{{--                                            </span>--}}
                                    ...
                                    <button type="submit" class="elementor-button elementor-size-sm btn-primary"
                                            ...
                                            <span>
                                                ...
                                                <span class="elementor-button-text " style="background: #00A2F2 !important;">Valider</span>
                                            </span>
                                    </button>
                                </div>
                            </div>
