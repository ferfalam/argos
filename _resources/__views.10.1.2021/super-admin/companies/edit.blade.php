        ...
        <div class="col-xs-12">
            ...
            <div class="panel-4">
                <div class="panel-heading">
                    <h2>@lang('app.update') @lang('app.company') [ {{$company->company_name}} ]</h2>
                    @php($class = ($company->status == 'active') ? 'label-custom' : 'label-danger')

                    <span class="btn rounded-pill label {{$class}}" style="margin-bottom: 10px">{{ucfirst($company->status)}}</span>
                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" value="{{$companyUser->id}}" name="userid">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
