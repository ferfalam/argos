...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
            <a class="btn btn-cs-blue btn-outline btn-sm"
            ...
            @endif
            <button type="button" onclick="showPayments()" class="btn btn-cs-blue btn-sm">
...
@section('content')
    <x-panel-container>
        <x-stat-card count="{{ currency_formatter($invoice->total,$invoice->currency->currency_symbol)}}" img="card-1.png" title="modules.payments.totalAmount" ></x-stat-card>
        <x-stat-card count="{{ currency_formatter($invoice->amountPaid(),$invoice->currency->currency_symbol) }}" img="card-2.png" title="modules.payments.totalPaid" ></x-stat-card>
        <x-stat-card count="{{ currency_formatter($invoice->amountDue(),$invoice->currency->currency_symbol) }}" img="card-3.png" title="modules.payments.totalDue" ></x-stat-card>
    </x-panel-container>
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="white-box printableArea ribbon-wrapper" style="display: grid">
