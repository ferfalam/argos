    ...
    <div class="panel-container">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <img src="{{asset('img/dashboard/dashboard-card-1.png')}}" alt="" />
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <img src="{{asset('img/dashboard/dashboard-card-2.png')}}" alt="" />
                <div class="panel-body-info">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <img src="{{asset('img/dashboard/dashboard-card-3.png')}}" alt="" />
                <div class="panel-body-info">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <img src="{{asset('img/dashboard/dashboard-card-4.png')}}" alt="" />
                <div class="panel-body-info">
