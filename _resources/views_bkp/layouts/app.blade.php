...
<div class="header navbar-header">
  ...
  <div class="header-left" >
      <a href="/" class="logo" style="height: 40px; line-height: none; display:inline;">
  ...
  <ul class="nav user-menu">
    ...
    {{-- <li class="nav-item">
      <select class="dropdown pull-right" id="trans" data-width="fit" onchange="translateLanguage(this.value);">
        <option value="en" @if($global->locale == "en") selected @endif>
          <span class="flag-icon flag-icon-gb"></span><span style="color: inherit;font-size:15px;padding-left:5px">English </span></span>
        </option>
      </select>
    </li> --}}
