...
@section('page-title')
    <div class="row bg-title" style="margin-top: 60px;">
        <!-- .page title -->
    ...
    <div class="white-box">
        <div class="row dashboard-stats front-dashboard">
            ...
            <div class="col-md-3 col-sm-6">
                <a href="{{url('super-admin/companies')}}">
                    <div class="white-box">
                        <div class="row">
                            <div class="col-xs-3">
                                <div>
            ...
            <div class="col-md-3 col-sm-6">
                <a href="{{url('super-admin/packages')}}">
                    <div class="white-box">
                        <div class="row">
                            <div class="col-xs-3">
                                <div>
            ...
            <div class="col-md-3 col-sm-6">
                <a href="{{url('super-admin/invoices')}}">
                    <div class="white-box">
                        <div class="row">
                            <div class="col-xs-3">
                                <div>
                                    <span class="bg-inverse-gradient"><i class="icon-printer fa-fw"></i></span>
                                </div>
                            </div>
                            <div class="col-xs-9 text-right">
                                <span class="widget-title"> @lang('app.total') Invoices</span><br>
                                <span class="counter">{{ count($allInvoices) }}</span>
                            </div>
                        </div>
                    </div>
                </a>
                ...
                <a href="{{url('super-admin/invoices')}}">
                    <div class="white-box">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <span class="widget-title"> @lang('app.total') Amount</span><br>
                                <span class="counter">{{ collect($allInvoices)->sum('amount') }}</span>
                            </div>
                        </div>
                    </div>
                </a>
