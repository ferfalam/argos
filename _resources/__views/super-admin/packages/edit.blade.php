                                ...
                                <div class="col-md-6 monthly_package">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step='0.01' name="monthly_price" id="monthly_price" value="{{ $package->monthly_price ?? '' }}" class="form-control plan_value">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                ...
                                <div class="col-md-6 annual_package">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step='0.01' name="annual_price" id="annual_price" value="{{$package->annual_price ?? ''}}"  class="form-control plan_value">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
