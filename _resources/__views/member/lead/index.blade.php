...
@section('content')
    ...
    <div class="panel-container">
        <x-stat-card img="card-1.png" count="{{ $totalLeads }}" title="modules.dashboard.totalLeads"></x-stat-card>
        <x-stat-card img="card-2.png" count="{{ $totalClientConverted }}" title="modules.dashboard.totalConvertedClient"></x-stat-card>
        <x-stat-card img="card-3.png" count="{{ $pendingLeadFollowUps }}" title="modules.dashboard.totalPendingFollowUps"></x-stat-card>
    </div>
