...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12">
            <x-main-header title="">
                <x-slot name="title">
                    <p4 class="page-title">@lang('app.menu.tasks')</p4>
                </x-slot>
                <x-slot name="btns">
            ...
            <section id="section-line-3" class="show">
                    <div id="task-list-panel">
                        ...
                        <div class="row m-b-10 m-t-20">
                            <div class="col-xs-12 hide" id="new-task-panel">
                                <div class="panel panel-default">
                                    <div class="panel-heading "><i class="ti-plus"></i> @lang('modules.tasks.newTask')
                                        <div class="panel-action">
                                            <a href="javascript:;" id="hide-new-task-panel" class="text-white"><i class="ti-close"></i></a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xs-12 hide" id="edit-task-panel">
                            </div>
                        </div>
