                            ...
                            <div class="row">
                                <div class="col-xs-12" id="invoices-list-panel">
                                    <div class="white-box">
                                        ...
                                        <ul class="list-group m-t-30" id="invoices-list">
                                            @forelse($project->invoices as $invoice)
                                                <li class="list-group-item">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <a href="{{ route('client.project-invoice.download', $invoice->id) }}" data-toggle="tooltip" data-original-title="Download" class="btn btn-default btn-circle" style="padding: 6px !important;" ><i class="fa fa-download"></i></a>
