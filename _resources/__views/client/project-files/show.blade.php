                ...
                <div class="row">
                    <div class="col-xs-12" id="files-list-panel">
                        <div class="white-box">
                            <x-main-header>
                                ...
                                <x-slot name="btns">
                                    <a href="javascript:;" id="show-dropzone"
                                       class="btn btn-cs-green btn-outline"><i class="ti-upload"></i> @lang('modules.projects.uploadFile')</a>

                                </x-slot>
                            </x-main-header>

                            <div class="row m-b-20 m-t-20 hide" id="file-dropzone" style="display: -webkit-box !important;">
                                <div class="col-xs-12">
                                    @if($upload)
                            ...
                            <ul class="nav customtab nav-tabs m-t-30" role="tablist" id="list-tabs">
                                ...
                                <li role="presentation" class="nav-item" data-pk="thumbnail"><a style="margin-bottom:0px;" href="#thumbnail" class="nav-link thumbnail" aria-controls="profile" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"><i class="ti-user"></i></span> <span class="hidden-xs">Thumbnail</span></a></li>
                            </ul>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <a href="{{ route('client.files.download', $file->id) }}"
                                                           ...
                                                           class="btn btn-default btn-circle" style="padding: 6px !important;"><i
