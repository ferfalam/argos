...
<nav id="sidebar"  onclick='width()' role="navigation">
    ...
    <ul class="list-unstyled components" style="padding-top: 0px">
        ...
        <li>
            <a href="#dashboard" data-toggle="collapse" aria-expanded="false"> <ion-icon name="rocket-outline"></ion-icon>@lang('app.menu.dashboard')  </a>
        ...
        <li>
            <a href="#third" data-toggle="collapse" aria-expanded="false"> <ion-icon name="grid"></ion-icon>Les tiers  </a>
            <ul class="collapse list-unstyled" id="third">
                <li class="{{ request()->routeIs('admin.clients.index') ? 'active' : '' }}">
                    <a href="{{ route('admin.clients.index') }}" > @lang('app.menu.clients') </a>
                </li>
                <li><a href="#" class="">Fournisseurs </a></li>
            </ul>
        </li>
        ...
        @if (in_array('projects', $modules) || in_array('tasks', $modules) || in_array('timelogs', $modules) || in_array('contracts', $modules))
            <li>
                <a href="#projects" data-toggle="collapse" aria-expanded="false"> <ion-icon name="rocket-outline"></ion-icon>Gestion de projets </a>
...
{{-- 
        ...
        <li>
            <a class="{{ request()->routeIs('admin.settings.index') ? 'active' : '' }}" href="#settings" data-toggle="collapse" aria-expanded="false">  
                <ion-icon name="settings-outline"></ion-icon>
                @lang('app.menu.settings') 
            </a>
