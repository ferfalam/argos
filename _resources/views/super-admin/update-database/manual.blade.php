                        ...
                        <div id="vhome3" class="tab-pane active">
                            ...
                            @if (!is_null($envatoUpdateCompanySetting->supported_until) && !\Carbon\Carbon::parse($envatoUpdateCompanySetting->supported_until)->isPast())
                                @if (isset($lastVersion))
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <h4 class="box-title" id="structure">@lang('modules.update.updateManual')
                                            </h4>
                                        </div>
        ...
        <script type="text/javascript">
                ...
                $.easyAjax({
                    ...
                    success: function(response) {
                        ...
                        $('#download-progress').append(
                            "<br><i><span class='text-success'>Installed successfully. Reload page to see the changes.</span>.</i>"
                            );
            ...
            $('.install-files').click(function() {
                $('#install-process').html(
                    '<div class="alert alert-info ">Installing...Please wait (This may take few minutes.)</div>');
