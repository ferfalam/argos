                                ...
                                <div class="col-sm-12">
                                    <div class="white-box">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select name="language" class="form-control selectpicker"
                                                    ...
                                                    <option @if (is_null($footer->language_setting_id)) selected @endif value="0"
                                                        data-content=" <span class='flag-icon flag-icon-us'></span> En">
                                                    </option>
                                                    @forelse ($activeLanguages as $language)
                                                        <option @if ($language->id === $footer->language_setting_id) selected @endif value="{{ $language->id }}"
                                                            data-content=' <span class="flag-icon flag-icon-{{ $language->language_code }}"></span> {{ ucfirst($language->language_code) }}'>
                                                        </option>
                                                    @empty
                                                    @endforelse
                                                </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" value="{{ $footer->name }}"
                                                    id="title" name="title">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label"
                                                    for="name">@lang('modules.footerSettings.pageContent')</label>
                                                <div class="col-sm-10 radio-list">
                                                    <label class="radio-inline p-0">
                                                        <div class="radio radio-info">
                                                            <input type="radio" @if (!is_null($footer->description)) checked @endif
                                                                class="upload-video" name="content" id="desc"
                                                                value="desc">
                                                            <label
                                                                for="content_type_desc">@lang('modules.footerSettings.useDescription')</label>
                                                        </div>
                                                    </label>
                                                    <label class="radio-inline">
                                                        <div class="radio radio-info">
                                                            <input type="radio" class="upload-video"
                                                                @if (!is_null($footer->external_link)) checked @endif name="content" id="link"
                                                                value="link">
                                                            <label
                                                                for="content_type_link">@lang('modules.footerSettings.useExternalLink')</label>
                                                        </div>
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group @if (!is_null($footer->external_link)) hideBox @endif" id="descBox">
                                            <label class="col-sm-2 control-label"
                                                for="name">@lang('app.description')</label>
                                            <div class="col-sm-10">
                                                <textarea type="text" class="form-control summernote" id="description"
                                                    rows="3" name="description"> {!! $footer->description !!} </textarea>
                                                <div class="form-control-focus"> </div>
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group  @if (!is_null($footer->description)) hideBox @endif" id="linkBox">
                                            <label class="col-sm-2 control-label"
                                                for="videoLink">@lang('modules.footerSettings.externalLink')</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control"
                                                    value="{{ $footer->external_link }}" id="external_link"
                                                    name="external_link">
                                                <div class="form-control-focus"> </div>
                                                <span class="help-block"></span>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select name="status" id="status" class="form-control">
                                                    <option @if ($footer->status == 'active') selected @endif value="active">@lang('app.active')
                                                    </option>
                                                    <option @if ($footer->status == 'inactive') selected @endif value="inactive">@lang('app.inactive')
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label"
                                                for="sttaus">@lang('app.changeToPosition')</label>
                                            <div class="col-sm-10">
                                                <select name="type" id="type" class="form-control">
                                                    <option @if ($footer->type == 'footer') selected @endif value="footer">@lang('app.footer')
                                                    </option>
                                                    <option @if ($footer->type == 'header') selected @endif value="header">@lang('app.header')
                                                    </option>
                                                    <option @if ($footer->type == 'both') selected @endif value="both">@lang('app.both')
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div id="seoBox" class="@if (!is_null($footer->external_link)) hideBox @endif">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label"
                                                    for="seo_title">@lang('modules.frontCms.seo_title')</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label"
                                                    for="seo_author">@lang('modules.frontCms.seo_author')</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="seo_author"
                                                        name="seo_author"
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label"
                                                    for="seo_description">@lang('modules.frontCms.seo_description')</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label"
                                                    for="seo_keywords">@lang('modules.frontCms.seo_keywords')</label>
                                                <div class="col-sm-10">
