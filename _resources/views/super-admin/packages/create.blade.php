                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label required">@lang('app.max')
                                            @lang('app.menu.employees')</label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="-1" id="max_storage_size" name="max_storage_size" value=""
                                            class="form-control">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="checkbox checkbox-info">
                                            <input id="is_free" name="is_free" value="true" type="checkbox">
                                ...
                                <div class="col-md-6 hide-box">
                                    <div class="form-group">
                                        ...
                                        <div class="checkbox checkbox-info">
                                            <input id="is_auto_renew" name="is_auto_renew" value="true" type="checkbox">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="position" name="sort" value="{{ $position }}"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label required">@lang('app.annual') @lang('app.price')
                                                ({{ $global->currency->currency_symbol }})</label>
                                            <input type="number" step='0.01' name="annual_price" id="annual_price" value=""
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
