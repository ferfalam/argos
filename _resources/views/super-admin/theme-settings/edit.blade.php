                                ...
                                <div class="col-sm-12">
                                        ...
                                        <div class="radio-list">
                                            <label class="radio-inline p-0">
                                                <div class="radio radio-info">
                                                    <input type="radio" name="active_theme" @if ($global->active_theme == 'default') checked @endif
                                                        id="default_theme" value="default">
                                                    <label
                                                        for="default_theme">@lang('modules.themeSettings.useDefaultTheme')</label>
                                                </div>
                                            </label>
                                            <label class="radio-inline">
                                                <div class="radio radio-info">
                                                    <input type="radio" name="active_theme" id="custom_theme"
                                                        @if ($global->active_theme == 'custom') checked @endif value="custom">
                                                    <label
                                                        for="custom_theme">@lang('modules.themeSettings.useCustomTheme')</label>
                                                </div>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label">@lang('modules.themeSettings.enableRtl')
                                        </label>
                                        <div class="switchery-demo">
                                            <input type="checkbox" id="rtl" name="rtl" @if ($global->rtl == true) checked
                                    ...
                                    <div id="custom-theme-options" @if ($global->active_theme == 'default') style="display: none" @endif>
                                        ...
                                        <h3 class="box-title m-b-0">
                                            <b>@lang('modules.themeSettings.superAdminPanelTheme')</b></h3>
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="example">
                                                    <p class="box-title m-t-30">@lang('modules.themeSettings.headerColor')
                                                    </p>
                                                    <input type="text" class="colorpicker form-control header_color"
                                                        required name="theme_settings[1][header_color]"
                                                        value="{{ $adminTheme->header_color }}" />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="example">
                                                    <p class="box-title m-t-30">@lang('modules.themeSettings.sidebarColor')
                                                    </p>
                                                    <input type="text"
                                                        class="complex-colorpicker sidebar_color form-control" required
                                                        name="theme_settings[1][sidebar_color]"
                                                        value="{{ $adminTheme->sidebar_color }}" />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="example">
                                                    <p class="box-title m-t-30">
                                                        @lang('modules.themeSettings.sidebarTextColor')</p>
                                                    <input type="text"
                                                        class="complex-colorpicker sidebar_text_color form-control" required
                                                        name="theme_settings[1][sidebar_text_color]"
                                            ...
                                            <div class="col-md-3">
                                                <div class="example">
                                                    ...
                                                    <input type="text" class="complex-colorpicker link_color form-control"
                                                        required name="theme_settings[1][link_color]"
...
@push('footer-script')
    ...
    <script src="{{ asset('plugins/bower_components/jquery-asColorPicker-master/dist/jquery-asColorPicker.min.js') }}">
    </script>
