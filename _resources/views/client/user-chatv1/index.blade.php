...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 bg-title-left">
            <h4 class="page-title"> ds {{ __($pageTitle) }}</h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
        ...
        <div class="chat-main-box">
            ...
            <div class="chat-left-aside">
                ...
                <div class="chat-left-inner">
                    <div class="form-material"><input class="form-control p-20" id="userSearch" type="text" placeholder="@lang("modules.messages.searchContact")"></div>
...
@section('chat-content')
    <!-- Page Content Holder -->
    <main class="main main-tertiary" style="margin-top: 60px">
        <!-- Chat Sidebar Start -->
