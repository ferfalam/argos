                    ...
                    <table class="table table-hover table-bordered text-center">
                        ...
                        <tr class="active">
                            ...
                            @if($package->monthly_status == '1')
                                <th style="@if(($i%2==1)) background-color:#00c2fa !important; @else background-color:#0355cd !important; @endif">
                                    <center>
                                        <h3 style="color: white !important; font-weight: 400">{{ucfirst($package->name)}}</h3>
                                    </center>
                                </th>
                    ...
                    <table class="table table-hover table-bordered text-center">
                        ...
                        <tr class="active">
                            ...
                            @if($package->annual_status == '1')
                                <th style="@if(($i%2==1)) background-color:#00c2fa !important; @else background-color:#0355cd !important; @endif">
                                    <center><h3 style="color: white !important; font-weight: 400">{{ucfirst($package->name)}}</h3></center>
                                </th>
                            @endif
                                @php
                                    $i++;
