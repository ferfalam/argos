...
<x-main-header>
    ...
    <x-slot name="btns">
        {{-- <x-link id="toggle-filter" url="javascript:;"  classes="small-btn-inverse btn-sm toggle-filter" icon="fa fa-sliders"></x-link> --}}
        <x-link type="modal" url="javascript:;" modalId="#my-event" classes="btn btn-cs-blue " icon="fa fa-plus" title="modules.events.addEvent"/>
    </x-slot>
</x-main-header>
...
<div class="row" " id="ticket-filters">
    <form action="" id="filter-form">
        <x-filter-form-group label="app.employees">
        ...
        <x-filter-form-group label="modules.events.eventType">
