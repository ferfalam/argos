                            ...
                            <div class="elementor-widget-container">
                                ...
                                @endif
                                    ...
                                    <div
                                        ...
                                        <p class="mb-3">Nous vous avons envoyés un email de confirmation pour
                                            votre inscription
                                        <p>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <button  onclick="location.href='{{url('login')}}';" type="submit" class="elementor-button elementor-size-sm">
													<span>
