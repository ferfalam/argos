...
return array(
    ...
    array(
        ...
        'requestTask' => "Request Task",
        'requestTaskAdd' => "Request Task Add",
    ...
    array(
        ...
        'paymoncommerce' => 'Pay via Mon Commerce',
        'taxName' => 'Tax Name',
        'rate' => 'Rate',
    ...
    array(
        ...
        'bulkAttendance' => 'Attendance Module'
    ),
    'customFields' =>
    array(
        'label' => 'Label',
    ...
    'projects' => array(
        ...
        'projectBudget' => "Project Budget",
        'hours_allocated' => "Hours Allocated",
        'clientTaskNotification' => "Client Task Notification",
        'clientViewTask' => "Client View Task",
        'selectClient' => "Select Client",
        'dropFile' => "Drop File",
        'budgetInfo' => "Budget Info",
        'clientInfo' => "Client Info",
        'note' => "Note",
        'projectSummary' => "Project Summary",
        'addMemberTitle' => "Add Member Title",
        'manualTimelog' => "Manual TimeLog",
        'withoutDeadline' => "Without Deadline",
        'deadline' => "Deadline",
        'startDate' => "Start Date",
        'projectName' => "Project Name",
        'projectCategory' => "Project Category",
        'addMemberTitle' => "Add Memeber Title",
        'createTitle' => "Create Project",
        'projectInfo' => "Project Info",
        'projectCompletionStatus' => "Project Completion Status",
        'calculateTasksProgress' => "Calculate Tasks Progress",
        'clientFeedback' => 'Client Feedback',
        ...
        'viewGanttChart' => "View Gantt Chart",
        'createMilestone' => "Create Milestone",
        'milestoneTitle' => "Milestone Title",
        'milestoneCost' => 'Milestone Cost',
        'addCostProjectBudget' => "Add Cost Project Budget",
        'milestoneSummary' => "Milestone Summary",
        'uploadFile' => "Upload File",
        'uploadImage' => "Upload Image",
        'addFileLink' => "Add File Link",
        'expenses_total' => "Expenses Total",
        'activityTimeline' => "Activity Time Line",
    ...
    array(
        ...
        'moncommercesitenumber' => 'Site Number',
        'moncommercerownumber' => 'Row Number',
        'moncommercehmackey' => 'HMAC Key',
        'moncommerceStatus' => 'MonCommerce Status',
        'moncommercesiteidentifier' => 'MonCommerce Site Identifier',
    ...
    array(
        ...
        'recentRegisteredCompanies' => 'list Of Group Companies',
