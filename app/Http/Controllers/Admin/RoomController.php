...
class RoomController extends AdminBaseController
{
    ...
    public function index(RoomDataTable $dataTable)
    {
        ...
        return $dataTable->render('admin.room.index', $this->data);
    }
    ...
    public function create()
    {
        ...
        return view('admin.room.ajax', compact('rooms'));
    }
    ...
    public function store(StoreRoom $request)
    {
        ...
        $room->save();
        if($request->ajax()){
            return Reply::successWithData(__('messages.categoryAdded'),['data' => Room::where('company_id',company()->id)->get()]);
        }
