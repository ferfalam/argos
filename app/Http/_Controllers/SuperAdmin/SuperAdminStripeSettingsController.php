...
class SuperAdminStripeSettingsController extends SuperAdminBaseController
{
    ...
    public function update(UpdateRequest $request)
    {
        ...
        $stripe->moncommercesitenumber = $request->moncommercesitenumber;
        $stripe->moncommercerownumber = $request->moncommercerownumber;
        $stripe->moncommercehmackey = $request->moncommercehmackey;
        $stripe->moncommerce_environment = $request->moncommerce_environment;
        $stripe->moncommercesiteidentifier = $request->moncommercesiteidentifier;
        ($request->mon_commerce_status) ? $stripe->mon_commerce_status = 'active' : $stripe->mon_commerce_status = 'inactive';
        $stripe->save();
