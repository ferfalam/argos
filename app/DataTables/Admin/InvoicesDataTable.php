...
class InvoicesDataTable extends BaseDataTable
{
    ...
    public function query(Invoice $model)
    {
        ...
        $model = $model->with(['project' => function ($q) {
            ...
            ->select('invoices.id', 'invoices.project_id', 'invoices.client_id', 'invoices.invoice_number', 'invoices.currency_id', 'invoices.total', 'invoices.status', 'invoices.issue_date', 'client_details.company_name', 'invoices.credit_note', 'invoices.show_shipping_address', 'invoices.send_status', 'invoices.invoice_recurring_id', 'client_details.name', 'users.name')
