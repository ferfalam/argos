...
class Company extends BaseModel
{
    ...
    protected $fillable = ['last_login', 'company_name', 'company_email', 'company_phone', 'website', 'address', 'currency_id', 'timezone', 'locale', 'date_format', 'time_format', 'week_start', 'longitude', 'latitude', 'status','siret','siren','naf','rcs', 'supervisor_id'];
    ...
    /**
     * Get the companySubSetting associated with the Company
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasOne
     */
    public function companySubSetting()
    {
        return $this->hasOne(CompanySubSettings::class);
    }
