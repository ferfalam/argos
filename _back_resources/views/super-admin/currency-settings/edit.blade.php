...
@section('content')
    ...
    <div class="row container">
        <div class="col-md-6">
            <div class="white-box white white-style">
                    ...
                    <div class="col-sm-12 col-xs-12">
                            ...
                            <div class="radio-list">
                                <label class="radio-inline p-0">
                                    <div class="radio radio-info">
                                        <input type="radio" name="is_cryptocurrency" @if ($currency->is_cryptocurrency == 'yes') checked @endif
                                ...
                                <label class="radio-inline">
                                    <div class="radio radio-info">
                                        <input type="radio" name="is_cryptocurrency" @if ($currency->is_cryptocurrency == 'no') checked @endif
                                            id="crypto_currency_no" value="no">
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-list">
                                <label class="radio-inline p-0">
                                    <div class="radio radio-info">
                                        <input type="radio" name="currency_position" @if ($currency->currency_position == 'front') checked @endif
                                            id="currency_position" value="front">
                                        <label for="currency_position">@lang('modules.currencySettings.front') (
                                            @lang('modules.currencySettings.example'): <span
                                                class="currency_symbol_show">{{ $currency->currency_symbol }}</span>1000)</label>
                                    </div>
                                </label>
                                <label class="radio-inline">
                                    <div class="radio radio-info">
                                        <input type="radio" name="currency_position" @if ($currency->currency_position == 'behind') checked @endif
                                            id="currency_position" value="behind">
                                        <label for="currency_position">@lang('modules.currencySettings.behind') (
                                            @lang('modules.currencySettings.example') : 1000<span
                                                class="currency_symbol_show">{{ $currency->currency_symbol }}</span>)
                                        </label>
                                    </div>
                                </label>
                            </div>
