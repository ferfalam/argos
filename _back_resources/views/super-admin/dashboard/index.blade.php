...
@section('content')
    <x-panel-container>
        <x-stat-card img="card-1.png" url="{{ url('super-admin/companies') }}" count="{{ $totalCompanies }}"
            title="{!! trans('app.collaborateur') !!}"></x-stat-card>
        <x-stat-card img="card-2.png" url="" count="{{ $activeCompanies }}" title="{!! trans('app.rechercheencours') !!}"></x-stat-card>
        <x-stat-card img="card-3.png" url="" count="{{ $expiredCompanies }}" title="{!! trans('app.devencours') !!}"></x-stat-card>
        <x-stat-card img="card-4.png" url="" count="{{ $inactiveCompanies }}" title="{!! trans('app.tacheencours') !!}">
        </x-stat-card>
        <x-stat-card img="card-5.png" url="" count="{{ count($allInvoices) }}" title="{!! trans('app.totalcontact') !!}">
        </x-stat-card>
    </x-panel-container>
