    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12 bg-title-left">
            <h4 class="page-title" style="min-width: max-content"> {{ __($pageTitle) }}
                <span class="text-info b-l p-l-10 m-l-5">{{ $totalRequest }}</span> <span class="font-12 text-muted m-l-5">
                    @lang('app.total') @lang('app.offlineRequest')</span>
            </h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
    ...
    <script>
        var table = $('#users-table').dataTable({
            ...
            columns: [{
                ...
                {
                    data: 'offline_method.name',
                    name: 'offline_method.name'
                },
                {
                    data: 'status',
                    name: 'status'
                        ...
                        $.easyAjax({
                            ...
                            success: function(response) {
                                if (response.status == "success") {
                                    ...
                                    $('#totalPackages').text(parseInt(total) - parseInt(
                                        1));
                                    table._fnDraw();
                                }
                            }
