                                            ...
                                            <div class="col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="primary_color"
                                                                class="gradient-colorpicker form-control" autocomplete="off"
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            <label
                                                                for="address">@lang('modules.frontCms.defaultLanguage')</label>
                                                            <select name="default_language" id="default_language"
                                                                ...
                                                                @foreach ($languageSettings as $language)
                                                                    <option value="{{ $language->language_code }}"
                                                                        @if ($frontDetail->locale == $language->language_code) selected @endif>
                                                    ...
                                                    <div class="col-sm-12 col-md-12 col-xs-12">
                                                        <div class="form-group">
                                                            <label for="custom_css"
                                                                class="d-block">@lang('modules.frontCms.customCss')</label>
                                                            <textarea name="custom_css" class="my-code-area" rows="20"
                                                                style="width: 100%">@if (is_null($frontDetail->custom_css_theme_two))/*Enter your auth css after this line*/ @else {!! $frontDetail->custom_css_theme_two !!}  @endif</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-xs-12">
                                                        <div class="form-group">
                                                            <div class="checkbox checkbox-info  col-md-10">
                                                                <input id="get_started_show" name="get_started_show"
                                                                    value="yes" @if ($frontDetail->get_started_show == 'yes') checked
                                                                @endif
                                                                type="checkbox">
                                                                <label
                                                                    for="get_started_show">@lang('modules.frontCms.getStartedButtonShow')</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-xs-12">
                                                        <div class="form-group">
                                                            <div class="checkbox checkbox-info  col-md-10">
                                                                ...
                                                                type="checkbox">
                                                                <label
                                                                    for="sign_in_show">@lang('modules.frontCms.singInButtonShow')</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <hr>
                                                <span
                                                    class="text-danger">@lang('modules.frontCms.socialLinksNote')</span><br><br>
                                                <div class="row">
                                                        ...
                                                        <div class="col-sm-12 col-md-3 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" id="{{ $link->name }}"
                                                                    name="social_links[{{ $link->name }}]" type="url"
                                                                    value="{{ $link->link }}"
                                                ...
                                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                    <li class="nav-item active">
                                                        <a class="nav-link active" id="en-tab" data-toggle="tab"
                                                            data-language-id="0" href="#en" role="tab" aria-controls="en"
                                                            aria-selected="true">
                                                    ...
                                                    @forelse ($activeLanguages as $language)
                                                        <li class="nav-item">
                                                            <a class="nav-link"
                                                                id="{{ $language->language_code }}-tab" data-toggle="tab"
                                                                data-language-id="{{ $language->id }}"
                                                                href="#{{ $language->language_code }}" role="tab"
                                                ...
                                                <div class="tab-content" id="edit-form">
                                                    @include('super-admin.front-settings.new-theme.edit-form',
                                                    ['trFrontDetail' => $trFrontDetail])
                                                </div>
                                            </div>
                                        </div>
                                    </div>
