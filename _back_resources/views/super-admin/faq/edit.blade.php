                        ...
                        <div class="form-group">
                            ...
                            <select class="selectpicker form-control" name="category_id" id="category_id"
                                ...
                                @forelse($categories as $category)
                                    <option @if ($faq->faq_category_id == $category->id) selected @endif value="{{ $category->id }}">
                    ...
                    <div class="col-xs-12 ">
                        <div class="form-group">
                            ...
                            <textarea name="description"
                                class="form-control summernote">{{ $faq->description }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            @if (is_null($file->external_link))
                                                <a href="{{ route('super-admin.faq.download', $file->id) }}"
                                                    ...
                                                    class="btn btn-inverse btn-circle"><i class="fa fa-download"></i></a>
                                            @endif
