...
<x-main-header>
    ...
    <x-slot name="btns">
        <x-link type="link" url="javascript:;" classes="btn btn-cs-blue timer-modal" icon="fa fa-clock-o" title="modules.projects.activeTimers"/>
        <x-link type="link" url="{{ route('admin.all-time-logs.index') }}" classes="btn btn-cs-green" icon="fa fa-list" :title="['app.timeLog', 'modules.employees.activity']"/>
        <x-link type="link" url="javascript:;" id="show-add-form" classes="btn btn-cs-green" icon="fa fa-clock-o" title="modules.timeLogs.logTime"/>
    </x-slot>
</x-main-header>
@endsection
...
@section('content')
    ...
    <div class="panel panel-default hide"  id="hideShowTimeLogForm">
