...
<ul class="nav tabs-vertical">
    <li
        ...
        <a href="{{ route('super-admin.settings.index') }}">@lang('app.menu.settings') @lang('app.global') </a></li>
    <li
        class="tab @if(\Illuminate\Support\Facades\Route::currentRouteName() == 'super-admin.email-settings.index') active @endif">
        <a href="{{ route('super-admin.email-settings.index') }}"> @lang('app.menu.settings') @lang('app.email')</a></li>
    <li
    ...
    {{-- <li
        ...
        <a href="{{ route('super-admin.push-notification-settings.index') }}"> @lang('app.menu.settings') @lang('app.menu.pushNotifications')
            </a>
    </li> --}}
    <li
        class="tab @if(\Illuminate\Support\Facades\Route::currentRouteName() == 'super-admin.language-settings.index') active @endif">
        <a href="{{ route('super-admin.language-settings.index') }}">@lang('app.menu.settings') @lang('app.language')  
           </a>
    </li>
    <li
