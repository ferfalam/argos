...
<nav id="sidebar"  onclick='width()' role="navigation">
    ...
    <ul class="list-unstyled components" style="padding-top: 0px">
        ...
        <li class="item-expanded">
            <a href="#dashboard" data-toggle="collapse" aria-expanded="{{ request()->routeIs('admin.dashboard') ? 'true' : 'false' }}"> <ion-icon name="rocket-outline"></ion-icon>@lang('app.menu.dashboard')  </a>
            <ul class="collapse list-unstyled {{ request()->routeIs('admin.dashboard') || request()->routeIs('admin.projectDashboard') ? 'in' : '' }}" id="dashboard">
                <li><a href="{{ route('admin.dashboard') }}" class="{{ request()->routeIs('admin.dashboard') ? 'active' : '' }}">Général </a></li>
                <li><a href="{{ route('admin.projectDashboard') }}" class="{{ request()->routeIs('admin.projectDashboard') ? 'active' : '' }}">Projets </a></li>
            </ul>
        </li>

        @php
           $is_employee_active = request()->routeIs('admin.employees.index') || 
                                request()->routeIs('admin.teams.index') || 
                                request()->routeIs('admin.designations.index') || 
                                request()->routeIs('admin.attendances.summary') || 
                                request()->routeIs('admin.holidays.index') || 
                                request()->routeIs('admin.leaves.pending');
        @endphp
        @if (in_array('employees', $modules) || in_array('attendance', $modules) || in_array('holidays', $modules) || in_array('leaves', $modules))
            <li>
                <a href="#employees" data-toggle="collapse" aria-expanded="{{$is_employee_active ? 'true' : 'false'}}"> <ion-icon name="people-outline"></ion-icon> Utilisateurs </a>
        ...
        <li>
            <a href="#third" data-toggle="collapse" aria-expanded="{{ request()->routeIs('admin.clients.index') ? 'true' : 'false' }}"> <ion-icon name="grid"></ion-icon>Les tiers  </a>
            <ul class="collapse list-unstyled {{ request()->routeIs('admin.clients.index') || request()->routeIs('admin.suppliers.index') ? 'in' : '' }}" id="third">
                <li >
                    <a href="{{ route('admin.clients.index') }}" class="{{ request()->routeIs('admin.clients.index') ? 'active' : '' }}"> @lang('app.menu.clients') </a>
                </li>
                <li><a href="{{route('admin.suppliers.index')}}" class="{{request()->routeIs('admin.suppliers.index') ? 'active' : ''}}">Fournisseurs </a></li>
            </ul>
        </li>
        ...
        @php
            $is_project_active = request()->routeIs('admin.projects.index') ||
            request()->routeIs('admin.all-tasks.index') ||
            request()->routeIs('admin.contracts.index');
        @endphp

        @if (in_array('projects', $modules) || in_array('tasks', $modules) || in_array('timelogs', $modules) || in_array('contracts', $modules))
            <li>
                <a href="#projects" data-toggle="collapse" aria-expanded="{{$is_project_active ? 'true' : 'false'}}"> <ion-icon name="rocket-outline"></ion-icon>Gestion de projets </a>
                <ul class="collapse list-unstyled {{$is_project_active ? 'in' : ''}}" id="projects">
                    @if (in_array('projects', $modules))
                        <li><a href="{{ route('admin.projects.index') }}" class="{{ request()->routeIs('admin.projects.index') ? 'active' : '' }}">Projets </a></li>
                    @endif
                    ...
                    @if (in_array('tasks', $modules))
                        ...
                        <li><a href="{{ route('admin.contracts.index') }}" class="{{ request()->routeIs('admin.contracts.index') ? 'active' : '' }}">Contrats</a></li>
                    @endif
                </ul>
            </li>
        @endif
