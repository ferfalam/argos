                                                    ...
                                                    <div class="col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="select2 form-control" id="storage"
                                                                name="storage">
                                                                <option value="local" @if (isset($localCredentials) && $localCredentials->status == 'enabled') selected
                                                                    @endif>Local (Default)</option>
                                                                <option value="aws" @if (isset($awsCredentials) && $awsCredentials->status == 'enabled') selected
                                                                    @endif>AWS S3 Storage (Amazon Web
                                                                    Services S3)</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 aws-form">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="select2 form-control" name="aws_region">
                                                                @foreach (\App\StorageSetting::$awsRegions as $key => $region)

                                                                    <option @if (isset($awsCredentials) && $awsCredentials->region == $key) selected @endif
                                                                        value="{{ $key }}">{{ $region }}
                                                                    </option>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="aws_bucket"
                                                                @if (isset($awsCredentials) && isset($awsCredentials->bucket))
