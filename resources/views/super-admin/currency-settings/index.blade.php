    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
            @if ($global->currency_converter_key)
                ...
                <a href="javascript:;" id="update-exchange-rates" class="btn btn-outline btn-info btn-sm">@lang('app.update')
                    @lang('modules.currencySettings.exchangeRate') <i class="fa fa-refresh" aria-hidden="true"></i></a>
                <a href="javascript:;" id="addCurrencyExchangeKey"
                    class="btn btn-outline btn-warning btn-sm">@lang('app.update')
                    @lang('modules.accountSettings.currencyConverterKey') <i class="fa fa-upload"
                                ...
                                <div class="col-sm-12">
                                    <div class="white-box ">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="text-center">
                                                    <div class="empty-space" style="height: 200px;">
                                                        <div class="empty-space-inner">
                                                            ...
                                                            <div class="subtitle">
                                                                <a href="javascript:;" id="addCurrencyExchangeKey"
                                                                    class="btn btn-outline btn-warning btn-sm">@lang('app.add')
                                            ...
                                            @else
                                                <h3 class="box-title m-b-0">@lang('modules.currencySettings.currencies')
                                                </h3>
                                                <div class="col-sm-12">
                                                    ...
                                                    @foreach ($currencies as $currency)
                                                        <tr>
                                                            <td>{{ ucwords($currency->currency_name) }}
                                                                {!! $global->currency_id == $currency->id ? "<label class='label label-success'>DEFAULT</label>" : '' !!}</td>
