    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 bg-title-left">@include('sections.ctrl_button')
            <h4 class="page-title" style="min-width: max-content"> {{ __($pageTitle) }}
                <span class="text-info b-l p-l-10 m-l-5">{{ $totalPackages }}</span> <span class="font-12 text-muted m-l-5">
                    @lang('app.total') @lang('app.menu.packages')</span>
            </h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
        ...
        $(function() {
            var table = $('#users-table').dataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'module_in_package',
                        name: 'module_in_package'
                    },
                    {
                        data: 'action',
                        name: 'action'
