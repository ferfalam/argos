                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="-1" id="max_storage_size" name="max_storage_size"
                                            value="{{ $package->max_storage_size ?? '' }}" class="form-control">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 hide-box">
                                    <div class="form-group">
                                        ...
                                        <div class="checkbox checkbox-info">
                                            <input id="is_auto_renew" name="is_auto_renew" @if ($package->is_auto_renew == 1) checked @endif
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="position" name="sort" value="{{ $package->sort }}"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row payment-box">
                                    ...
                                    <div class="form-group mt-10">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="switchery-demo">
                                                <input type="checkbox" data-value='monthly' class="js-switch packeges"
                                                    name="monthly_status" id="monthly_status" data-size="small"
                                                    data-color="#00c292" data-secondary-color="#f96262" value="true"
                                                    @if ($package->monthly_status == '1') checked @endif />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mt-10">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="switchery-demo">
                                                <input type="checkbox" name="annual_status" id="annual_status"
                                                    data-value='annual' class="js-switch packeges" data-size="small"
                                                    data-color="#00c292" data-secondary-color="#f96262" value="true"
                                                    @if ($package->annual_status == '1') checked @endif />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 monthly_package">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step='0.01' name="monthly_price" id="monthly_price"
                                                ...
                                                class="form-control plan_value">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>@lang('modules.package.stripeMonthlyPlanId')</label>
                                            <input type="text" name="stripe_monthly_plan_id" id="stripe_monthly_plan_id"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="razorpay_monthly_plan_id" id="razorpay_monthly_plan_id"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="paystack_monthly_plan_id" id="paystack_monthly_plan_id"
                                                value="{{ $package->paystack_monthly_plan_id ?? '' }}"
                                                class="form-control plan_value">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 annual_package">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label required">@lang('app.annual') @lang('app.price')
                                                ({{ $global->currency->currency_symbol }})</label>
                                            <input type="number" step='0.01' name="annual_price" id="annual_price"
                                                value="{{ $package->annual_price ?? '' }}" class="form-control plan_value">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label
                                                class="control-label">@lang('modules.package.stripeAnnualPlanId')</label>
                                            <input type="text" id="stripe_annual_plan_id" name="stripe_annual_plan_id"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label
                                                class="control-label">@lang('modules.package.razorpayAnnualPlanId')</label>
                                            <input type="text" id="razorpay_annual_plan_id" name="razorpay_annual_plan_id"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label
                                                class="control-label">@lang('modules.package.paystackAnnualPlanId')</label>
                                            <input type="text" id="paystack_annual_plan_id" name="paystack_annual_plan_id"
                                                value="{{ $package->paystack_annual_plan_id ?? '' }}"
                                                class="form-control plan_value">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="checkbox checkbox-info">
                                            <input id="private-task" name="is_private" value="true" @if ($package->is_private)
                                            checked
                                            @endif
                                            type="checkbox">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mt-10">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="switchery-demo">
                                                <input type="checkbox" id="is_recommended" @if ($package->is_recommended == 1)
                                                checked
                                                @endif
                                                name="is_recommended"
                                ...
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        <div class="checkbox checkbox-info  col-md-10">
                                            <input id="select_all_permission" class="select_all_permission"
                                                type="checkbox">
                                        ...
                                        @foreach ($modules as $module)
                                            ...
                                            <div class="col-md-2">
                                                <div class="checkbox checkbox-inline checkbox-info m-b-10">
                                                    ...
                                                    <label
                                                        for="{{ $module->module_name }}">{{ __('modules.module.' . $module->module_name) }}</label>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
