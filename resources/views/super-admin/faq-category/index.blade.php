...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
            <a href="javascript:void(0);" onclick="showFaqCategoryCreate()"
                class="btn btn-outline btn-success btn-sm">@lang('app.add') @lang('app.faqCategory') <i class="fa fa-plus"
...
@section('content')
    ...
    {{-- Ajax Modal --}}
    <div class="modal fade bs-modal-md in" id="faqModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
