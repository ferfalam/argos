...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-6 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
            <a href="javascript:;"
                class="btn btn-outline btn-success btn-sm addFrontFeature">@lang('modules.featureSetting.addFeature') <i
                                                ...
                                                @forelse($frontFeatures as $feature)
                                                    <tr>
                                                        ...
                                                        <td class="text-nowrap">
                                                            <a href="javascript:;"
                                                                data-front-feature-id="{{ $feature->id }}"
                                                                class="btn btn-info btn-circle editFrontFeature"
                                                                data-toggle="tooltip" data-original-title="Edit"><i
                                                                    class="fa fa-pencil" aria-hidden="true"></i></a>
                                                            <a href="{{ route('super-admin.front-feature-settings.show', $feature->id) }}"
                                                                class="btn btn-info btn-circle" data-toggle="tooltip"
                                                                data-original-title="View And Add Feature"><i
                                                                    class="fa fa-search" aria-hidden="true"></i></a>
                                                            <a href="javascript:;"
                                                                class="btn btn-danger btn-circle sa-params-feature"
                                                                data-toggle="tooltip"
                                                                data-front-feature-id="{{ $feature->id }}"
