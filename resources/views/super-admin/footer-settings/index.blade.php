                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <a href="{{ route('super-admin.footer-settings.create') }}"
                                                        class="btn btn-outline btn-success btn-sm addFeature">@lang('modules.footer.addFooter')
                                                ...
                                                <tbody>
                                                    @forelse($footer as $footerMenu)
                                                        <tr>
                                                            ...
                                                            <td>{{ $footerMenu->language ? $footerMenu->language->language_name : 'English' }}
                                                            </td>
                                                            <td>
                                                                @if ($footerMenu->status == 'active')
                                                                    <label
                                                                        class="label label-info">@lang('app.active')</label>
                                                                @else
                                                                    <label
                                                                        class="label label-danger">@lang('app.inactive')</label>
                                                                @endif
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td class="text-nowrap">
                                                                <a href="{{ route('super-admin.footer-settings.edit', $footerMenu->id) }}"
