...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 bg-title-left">
            ...
            <h4 class="page-title" style="min-width: max-content" style="min-width: max-content"> {{ __($pageTitle) }}
            </h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="alert alert-info">
                                        We recommend using <strong>SMTP</strong>. <strong>Mail</strong> settings might not
                                        work on every server which also
                                            ...
                                            <div class="col-md-12 ">
                                                ...
                                                <div class="form-group">
                                                    <label class="radio-inline"><input type="radio" class="checkbox"
                                                            onchange="getDriverValue(this);" value="mail"
                                                            @if ($smtpSetting->mail_driver == 'mail') checked @endif name="mail_driver">Mail</label>
                                                    <label class="radio-inline m-l-10"><input type="radio"
                                                            onchange="getDriverValue(this);" value="smtp"
                                                            @if ($smtpSetting->mail_driver == 'smtp') checked @endif name="mail_driver">SMTP</label>
                                                ...
                                                <div class="col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="mail_port" id="mail_port"
                                                            class="form-control" value="{{ $smtpSetting->mail_port }}">
                                                    </div>
                                                </div>
                                                <!--/span-->
                                        ...
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="mail_from_email" id="mail_from_email"
                                                    class="form-control" value="{{ $smtpSetting->mail_from_email }}">
                                            </div>
                                        </div>
                                    </div>
                                    <!--/span-->
