                                            ...
                                            <div class="col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="col-sm-12 col-md-12 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="custom_css" class="my-code-area" rows="20"
                                                                style="width: 100%">@if (is_null($frontDetail->custom_css))/*Enter your auth css after this line*/ @else {!! $frontDetail->custom_css !!} @endif</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" class="form-control" id="email"
                                                                name="email" value="{{ $frontDetail->email }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-6 col-xs-12">
                                                        <div class="form-group">
                                                            <label
                                                                for="phone">@lang('modules.accountSettings.companyPhone')</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            <label
                                                                for="address">@lang('modules.accountSettings.htmlOrEmbeded')</label>
                                                ...
                                                <div class="tab-content" id="edit-form">
                                                    @include('super-admin.front-settings.edit-form', ['trFrontDetail' =>
                                                    $trFrontDetail])
                                                </div>
                                            </div>
                                        </div>
