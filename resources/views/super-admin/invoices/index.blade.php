...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 bg-title-left">@include('sections.ctrl_button')
            <h4 class="page-title" style="min-width: max-content"> {{ __($pageTitle) }}
                <span class="text-info b-l p-l-10 m-l-5">{{ $totalInvoices }}</span> <span class="font-12 text-muted m-l-5">
                    @lang('app.total') @lang('app.menu.invoices')</span>
            </h4>
        </div>
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title" style="min-width: max-content">Total Amount
                <span class="text-info b-l p-l-10 m-l-5">{{ $global->currency->currency_symbol }} <span
                        id="intotal">{{ $totalInvoicesAmount }}</span></span>
            </h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
            ...
            function loadTable() {
                ...
                var table = $('#users-table').dataTable({
                    ...
                    columns: [{
                        ...
                        {
                            data: 'paid_on',
                            name: 'offline_invoices.pay_date'
                        },
                        {
                            data: 'next_pay_date',
                            name: 'offline_invoices.next_pay_date'
                        },
                        {
                            data: 'method',
                            name: 'offline_method_id'
                        },
                        {
                            data: 'action',
                            name: 'action'
