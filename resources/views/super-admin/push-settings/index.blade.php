...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12 bg-title-left">
            ...
            <h4 class="page-title" style="min-width: max-content" style="min-width: fit-content"> {{ __($pageTitle) }}
            </h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <label
                                                for="company_name">@lang('modules.pushSettings.oneSignalRestApiKey')</label>
                                            <input type="password" class="form-control" id="onesignal_rest_api_key"
                                                name="onesignal_rest_api_key"
                                                value="{{ $pushSettings->onesignal_rest_api_key }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control" id="">
                                                <option @if ($pushSettings->status == 'inactive') selected @endif value="inactive">@lang('app.inactive')
                                                </option>
                                                <option @if ($pushSettings->status == 'active') selected @endif value="active">@lang('app.active')</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group" style="display: none">
                                            <label for="exampleInputPassword1"
                                                class="d-block">@lang('modules.slackSettings.slackNotificationLogo')</label>
                                            ...
                                            @if (!is_null($pushSettings->notification_logo))
                                                <div class="form-group">
                                                    <label
                                                        for="removeImage">@lang("modules.emailSettings.removeImage")</label>
                                                    <div class="switchery-demo">
                                                        <input type="checkbox" name="removeImage" id="removeImageButton"
                                                            class="js-switch removeImage" data-color="#99d683" />
                                                    </div>
                                                </div>
                                            @endif
    ...
    @push('footer-script')
        ...
        <script>
            ...
            $('#removeImageButton').change(function() {
                ...
                if (removeButton == 'yes') {
                    img =
                        '<img src="https://via.placeholder.com/200x150.png?text={{ str_replace(' ', '+', __('modules.slackSettings.uploadSlackLogo')) }}" alt=""/>';
                } else {
                    img =
                        '<img src="{{ asset_url('notification-logo/' . $pushSettings->notification_logo) }}" alt=""/>'
                }
                $('.thumbnail').html(img);
