                                    ...
                                    <div class="form-body">
                                        <div class="form-group">
                                            <label for="google_client_id"
                                                class="control-label">@lang('app.clientId')</label>
                                            <input type="text" class="form-control  form-control-lg" id="google_client_id"
                                                name="google_client_id" value="{{ $calendarSetting->google_client_id }}">
                                        </div>

                                        <div class="form-group">
                                            <label for="google_client_secret"
                                                class="control-label">@lang('app.clientSecret')</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="google_calendar_status" class="form-control" id="">
                                                <option @if ($calendarSetting->google_calendar_status == 'inactive') selected @endif value="inactive">@lang('app.inactive')
                                                </option>
                                                <option @if ($calendarSetting->google_calendar_status == 'active') selected @endif value="active">@lang('app.active')</option>
                                            </select>
                                        </div>
                                    </div>
