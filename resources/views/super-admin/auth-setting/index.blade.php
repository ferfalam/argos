                                        ...
                                        <div class="col-sm-12 col-md-12 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                @if ($global->login_ui == 1 && $global->front_design == 1)
                                                    <textarea name="auth_css" class="my-code-area" rows="20"
                                                        style="width: 100%">@if (is_null($global->auth_css_theme_two))/*Enter your auth css after this line*/@else {!! $global->auth_css_theme_two !!} @endif</textarea>
                                                @else
                                                    <textarea name="auth_css" class="my-code-area" rows="20"
                                                        style="width: 100%">@if (is_null($global->auth_css))/*Enter your auth css after this line*/@else {!! $global->auth_css !!} @endif</textarea>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
