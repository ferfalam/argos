...
@section('page-title')
    <div class="row bg-title">
        ...
        <!-- /.breadcrumb -->
        @include('sections.filter_button');
    </div>
@endsection
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="switchery-demo">
                                                    <input type="checkbox" id="email_verification" name="email_verification"
                                                        @if ($global->email_verification == true)
                                                    checked
                                                    @endif class="js-switch " data-color="#00c292"
                                                    data-secondary-color="#f96262"/>
                                                </div>
                                    ...
                                    <div class="col-md-12 ">
                                        ...
                                        <div id="google-captcha-credentials" style="display: none;">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="radio-inline"><input value="v2" type="radio" id="v2"
                                                                name="version" @if ($global->google_captcha_version === 'v2') checked
                                                            @endif onclick="captcha();">v2</label>
                                                        <label class="radio-inline m-l-10"><input value="v3" id="v3"
                                                                type="radio" data-callback='onClick' name="version"
                                            ...
                                            <div id="google_captcha_v2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="google_recaptcha_key_v2"
                                                        id="google_captcha_site_key_v2" class="form-control form-control-lg"
                                                        value="{{ $globalSetting->google_captcha_version == 'v2' ? $globalSetting->google_recaptcha_key : '' }}">
                                                    @if ($errors->has('google_recaptcha_key'))
                                                        <span
                                                            class="text-danger">{{ $errors->first('google_recaptcha_key') }}</span>
                                                    @endif
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="google_recaptcha_secret_v2"
                                                        id="google_captcha_secret_v2" class="form-control form-control-lg"
                                            ...
                                            <div id="google_captcha_v3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="google_recaptcha_key_v3"
                                                        id="google_captcha_site_key_v3" class="form-control form-control-lg"
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <button type="submit" data-callback='onSubmit' id="update-captcha"
                                                style="display: none" class="btn btn-success  verify-captcha"><i></i>
                                                @lang('app.update')
                                            </button>
...
@push('footer-script')
    ...
    <script>
        ...
        $('#google_recaptcha_status').is(':checked') ? $('#google-captcha-credentials').show() : $(
            '#google-captcha-credentials').hide();
        '{{ $globalSetting->google_captcha_version }}' === 'v2' ? $('#google_captcha_v2').show(): $('#google_captcha_v2')
            .hide();
        '{{ $globalSetting->google_captcha_version }}' === 'v3' ? $('#google_captcha_v3').show(): $('#google_captcha_v3')
            .hide();
        //for modal
            ...
            $.easyAjax({
                ...
                success: function(response) {
                    if (response.status == 'success') {
                        ...
                        url = url + '?google_recaptcha_key=' + google_captcha_site_key.trim() +
                            '&google_recaptcha_secret=' + google_captcha_secret.trim() +
                            '&google_captcha_version=' + version + '&google_recaptcha_status=' +
                            google_recaptcha_status + '&system_update=' + system_update +
