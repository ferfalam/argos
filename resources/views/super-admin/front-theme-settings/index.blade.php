                                ...
                                <div class="row">
                                    <div class="col-md-12 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <select name="theme" id="theme"
                                                class="image-picker image-picker-theme show-labels show-html"
                                                style="color: white">
                                                ...
                                                <option data-img-src="{{ asset('img/new-design.jpg') }}"
                                                    ...
                                                    @if ($global->front_design == 1) selected @endif value="1">Theme 2
                                                </option>
                                        ...
                                        <div class="col-md-12 col-xs-12" id="login_ui_box">
                                            ...
                                            <div class="form-group">
                                                <select name="login_ui" id="login_ui"
                                                    class="image-picker show-labels show-html login-theme"
                                                    style="color: white">
                                                    ...
                                                    <option data-img-src="{{ asset('img/new-login.jpg') }}"
                                                        data-toggle="tooltip" data-original-title="Edit"
                                                        @if ($global->login_ui == 1) selected @endif value="1">Theme 2
                                                    </option>
                                    ...
                                    <div class="row login-background-box">
                                        <div class="col-sm-6 col-md-4">
                                            <div class="form-group">
                                                <p class="box-title m-t-30">@lang('modules.themeSettings.enableRoundTheme')
                                                </p>
                                                <div class="radio-list">
                                                    <label class="radio-inline p-0">
                                                        <div class="radio radio-info">
                                                            <input type="radio" id="rounded_theme_yes" name="rounded_theme"
                                                                @if ($global->rounded_theme) checked @endif value="1">
                                                            <label for="rounded_theme_yes">@lang('app.yes')</label>
                                                        </div>
                                                    </label>
                                                    <label class="radio-inline">
                                                        <div class="radio radio-info">
                                                            <input type="radio" id="rounded_theme_no" name="rounded_theme"
                                                                @if (!$global->rounded_theme) checked @endif value="0">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="example m-b-10">
                                                    <input type="text" class="complex-colorpicker form-control"
                                                        id="logo_background_color" required name="logo_background_color"
                                                        value="{{ $superadminTheme ? $superadminTheme->login_background : '' }}" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-4">
                                        ...
                                        <div class="form-group">
                                            <div class="switchery-demo">
                                                <input type="checkbox" id="frontend_disable" name="frontend_disable"
                                    ...
                                    <div id="set-homepage-div" @if ($global->frontend_disable)
                                        ...
                                        <div class="col-md-4 col-xs-12">
                                            <div class="form-group">
                                                <label
                                                    class="control-label">@lang('modules.superadmin.setupHomepage')</label>
                                                <select name="setup_homepage" id="setup_homepage"
                                                    class="form-control selectpicker">
                                                    <option @if ($global->setup_homepage == 'default')
                                                        selected
                                                        @endif
                                                        value="default">@lang('modules.superadmin.defaultLanding')</option>
                                                    <option @if ($global->setup_homepage == 'signup')
                                                        selected
                                                        @endif
                                                        value="signup">@lang('app.signup')</option>
                                                    <option @if ($global->setup_homepage == 'login')
                                                        selected
                                                        @endif
                                                        value="login">@lang('app.login')</option>
                                                    <option @if ($global->setup_homepage == 'custom')
                                                        selected
                                                        @endif
                                        ...
                                        <div class="col-xs-12 col-md-4" id="home_custom_url" @if ($global->frontend_disable || (!$global->frontend_disable && $global->setup_homepage != 'custom'))
                                            style="display:none"
                                            @endif
                                            >
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control"
                                                    value="{{ $global->custom_homepage_url }}" name="custom_homepage_url"
                                                    id="custom_homepage_url">
                                            </div>
                                        </div>
                                    </div>
