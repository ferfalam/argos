                                            ...
                                            <div class="col-sm-12 col-xs-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12 col-md-3 col-xs-12">
                                                        <div class="form-group">
                                                            <label
                                                                for="no_of_days">@lang('modules.packageSetting.noOfDays')</label>
                                                    ...
                                                    <div class="col-sm-12 col-md-3 col-xs-12">
                                                        <div class="form-group">
                                                            <label
                                                                for="no_of_days">@lang('modules.packageSetting.notificationBeforeDays')</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-6 col-xs-12">
                                                        <div class="form-group">
                                                            <label
                                                                for="no_of_days">@lang('modules.packageSetting.trialMessage')</label>
                                                            <input type="text" class="form-control" id="trial_message"
                                                                name="trial_message"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label required">@lang('app.storageUnit')</label>
                                                            <select name="storage_unit" id="storage_unit"
                                                                class="form-control">
                                                                <option value="mb" @if ($package->storage_unit == 'mb') selected @endif>
                                                                    @lang('app.mb')
                                                                </option>
                                                                <option value="gb" @if ($package->storage_unit == 'gb') selected @endif>
                                                                    @lang('app.gb')
                                                                </option>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="col-xs-12">
                                                        <div class="row form-group module-in-package">
                                                            @foreach ($modules as $module)
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div
                                                                        class="checkbox checkbox-inline checkbox-info m-b-10">
                                                                        <input id="{{ $module->module_name }}"
                                                                            name="module_in_package[{{ $module->id }}]"
                                                                            value="{{ $module->module_name }}"
                                                                            type="checkbox" @if (isset($packageModules) && in_array($module->module_name, $packageModules)) checked @endif>
                                                                        <label
                                                                            for="{{ $module->module_name }}">{{ ucfirst($module->module_name) }}</label>
                                                                    </div>
                                                                </div>
                                                            @endforeach
                                                        </div>
