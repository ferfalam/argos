                                    ...
                                    <div class="white-box">
                                        ...
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            ...
                                            @forelse ($activeLanguages as $language)
                                                <li class="nav-item">
                                                    <a class="nav-link" id="{{ $language->language_code }}-tab"
                                                        data-toggle="tab" data-language-id="{{ $language->id }}"
                                                        href="#{{ $language->language_code }}" role="tab"
                                                        aria-controls="{{ $language->language_code }}" aria-selected="true">
                                                        <span
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <a href="javascript:;"
                                                        class="btn btn-outline btn-success btn-sm addFeature">@lang('app.add')
                                                        @lang('app.frontClient') <i class="fa fa-plus"
                                                ...
                                                <tbody>
                                                    @forelse($frontClients as $frontClient)
                                                        <tr>
                                                            ...
                                                            <td>{{ $frontClient->language ? $frontClient->language->language_name : 'English' }}
                                                            </td>
                                                            <td>
                                                                <img height="40" width="120"
                                                                    src="{{ $frontClient->image_url }}" alt="" />
                                                            </td>
                                                    ...
                                                    @empty
                                                        <tr>
                                                            <td colspan="4" class="text-center">
                                                                @lang('messages.noRecordFound')</td>
                                                        </tr>
                                                    @endforelse
                                                </tbody>
                                            </table>
