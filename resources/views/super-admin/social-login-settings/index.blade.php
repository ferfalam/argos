                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        <h3 class="box-title text-success">
                                                            @lang('app.socialAuthSettings.google')</h3>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="password" name="google_secret_id"
                                                                id="google_secret_id" class="form-control"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="switchery-demo">
                                                                <input type="checkbox" data-type-name="google"
                                                                    name="google_status" @if ($credentials->google_status == 'enable') checked @endif
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <p class="text-info">(@lang('messages.addGoogleCallback'))
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12 m-t-20">
                                                        <h3 class="box-title text-warning">
                                                            @lang('app.socialAuthSettings.facebook')</h3>
                                                        <hr class="m-t-0 m-b-20">
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="facebook_client_id"
                                                                id="facebook_client_id" class="form-control"
                                                                value="{{ $credentials->facebook_client_id }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="password" name="facebook_secret_id"
                                                                id="facebook_secret_id" class="form-control"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="control-label">@lang('app.status')</label>
                                                            <div class="switchery-demo">
                                                                <input type="checkbox" data-type-name="facebook"
                                                                    name="facebook_status" @if ($credentials->facebook_status == 'enable') checked @endif
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="mail_from_name">@lang('app.callback')</label>
                                                            <p class="text-bold">
                                                                {{ route('social.login-callback', 'facebook') }}</p>
                                                            <p class="text-info">
                                                                (@lang('messages.addFacebookCallback'))</p>
                                                        </div>
                                                    </div>
                                                    <!--/span-->
                                                    ...
                                                    <div class="col-md-12 m-t-20">
                                                        <h3 class="box-title text-info">
                                                            @lang('app.socialAuthSettings.linkedin')</h3>
                                                        <hr class="m-t-0 m-b-20">
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="linkedin_client_id"
                                                                id="linkedin_client_id" class="form-control"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="password" name="linkedin_secret_id"
                                                                id="linkedin_secret_id" class="form-control"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="control-label">@lang('app.status')</label>
                                                            <div class="switchery-demo">
                                                                <input type="checkbox" data-type-name="linkedin"
                                                                    name="linkedin_status" @if ($credentials->linkedin_status == 'enable') checked @endif
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="mail_from_name">@lang('app.callback')</label>
                                                            <p class="text-bold">
                                                                {{ route('social.login-callback', 'linkedin') }}</p>
                                                            <p class="text-info">
                                                                (@lang('messages.addLinkedinCallback'))</p>
                                                        </div>
                                                    </div>
                                                    <!--/span-->
                                                    ...
                                                    <div class="col-md-12 m-t-20">
                                                        <h3 class="box-title text-success">
                                                            @lang('app.socialAuthSettings.twitter')</h3>
                                                        <hr class="m-t-0 m-b-20">
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="twitter_client_id"
                                                                id="twitter_client_id" class="form-control"
                                                                value="{{ $credentials->twitter_client_id }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="password" name="twitter_secret_id"
                                                                id="twitter_secret_id" class="form-control"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="control-label">@lang('app.status')</label>
                                                            <div class="switchery-demo">
                                                                <input type="checkbox" data-type-name="twitter"
                                                                    name="twitter_status" @if ($credentials->twitter_status == 'enable') checked @endif
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="mail_from_name">@lang('app.callback')</label>
                                                            <p class="text-bold">
                                                                {{ route('social.login-callback', 'twitter') }}</p>
                                                            <p class="text-info">(@lang('messages.addTwitterCallback'))
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <!--/span-->
