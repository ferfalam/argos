...
<!-- This is a Custom CSS -->
    ...
    request()->routeIs('super-admin.email-settings*') ||
    request()->routeIs('super-admin.security-settings*') ||
    request()->routeIs('super-admin.push-notification-settings*') ||
    request()->routeIs('super-admin.language-settings*') ||
    request()->routeIs('super-admin.currency*') ||
    request()->routeIs('super-admin.payment-settings*') ||
    request()->routeIs('super-admin.package-settings*') ||
    request()->routeIs('super-admin.custom-modules*') ||
    request()->routeIs('super-admin.custom-fields*') ||
    request()->routeIs('super-admin.storage-settings*') ||
    request()->routeIs('super-admin.theme-settings*') ||
    request()->routeIs('super-admin.profile*') ||
    request()->routeIs('super-admin.social-auth-settings*') ||
    request()->routeIs('super-admin.google-calendar-settings*') ||
    request()->routeIs('super-admin.update-settings*') )
        <style>
            .main-content{
                display: flex;
            }
        ...
        <div class="header navbar-header" style="display: flex; align-items: center; justify-content: space-between;">
            ...
            <div style="display: flex; align-items-center; gap:20px; margin-left : 100px">
                <div class="bg-white rounded-pill" style="padding: 0px 10px">
                    {{\Carbon\Carbon::now('Europe/Paris')->format('d/m/Y')}}
                </div>

                <div class="bg-white rounded-pill" style="padding: 0px 10px">
                    {{\Carbon\Carbon::now('Europe/Paris')->format('H:i A')}}
                </div>
