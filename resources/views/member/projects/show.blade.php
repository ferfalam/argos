...
<div class="row">
    <div class="col-xs-12">
        <div class="panel-container">
            <x-stat-card img="card-1.png" count="{{ count($openTasks) }}" title="app.openTasks"></x-stat-card>
            <x-stat-card img="card-2.png" count="{{ $daysLeft }}" title="app.daysLeft"></x-stat-card>
            <x-stat-card img="card-3.png" count="{{ $hoursLogged }}" title="modules.projects.hoursLogged"></x-stat-card>
        </div>
    </div>
</div>
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-xs-12" style="max-height: 400px; overflow-y: auto;">
                        <div class="panel panel-inverse">
                            <div class="panel-heading">
                                @lang('app.project') @lang('app.note')
                            </div>
                            <div class="panel-body">
                                {!! $project->notes !!}
                            </div>
