...
@section('content')
    ...
    <x-panel-container>
        <x-stat-card img="card-1.png" count="{{ $totalWorkingDays }}" title="modules.attendance.totalWorkingDays"></x-stat-card>
        <x-stat-card img="card-2.png" count="{{ $daysPresent }}" title="modules.attendance.daysPresent"></x-stat-card>
        <x-stat-card img="card-3.png" count="{{ $daysLate }}" :title="['app.days', 'modules.attendance.late']"></x-stat-card>
        <x-stat-card img="card-4.png" count="{{ $halfDays }}" title="modules.attendance.halfDay"></x-stat-card>
        <x-stat-card img="card-3.png" count="{{ (($totalWorkingDays - $daysPresent) < 0) ? '0' : ($totalWorkingDays - $daysPresent) }}" :title="['app.days', 'modules.attendance.absent']"></x-stat-card>
        <x-stat-card img="card-2.png" count="{{ $holidays }}" title="modules.attendance.holidays"></x-stat-card>
    </x-panel-container>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panle-default panel-body">
                <div class="row">
                    <div class="col-md-4">
