...
<x-main-header>
    ...
    <x-slot name="btns">
        <x-link type="link" url="{{ route('admin.products.create') }}"  classes="btn btn-cs-blue " icon="fa fa-plus" :title="['app.addNew', 'app.menu.products']"/>
    </x-slot>
</x-main-header>
    ...
    {{-- <div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 bg-title-left">
            <h4 class="page-title">  {{ __($pageTitle) }}
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
            <a href="{{ route('admin.products.create') }}" class="small-success-btn btn-sm">@lang('app.addNew') @lang('app.menu.products') <i class="fa fa-plus" aria-hidden="true"></i></a>
...
@section('filter-section')
    <form action="" id="filter-form">
        <div class="row">
            ...
            {{-- <div class="col-md-12">
                <div class="form-group">
                    <label for="" class="control-label">DEMo</label>
                    <button type="button" class="small-success-btn " id="filter-results"><i class="fa fa-check"></i> @lang('app.apply')
                    </button>
                    <button type="button" id="reset-filters"
                            class="small-inverse-btn col-md-offset-1"><i
