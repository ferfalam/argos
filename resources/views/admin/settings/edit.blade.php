                            ...
                            <div class="row">
                                ...
                                <span class="btn btn-info  btn-file">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="longitude">N°SIREN</label>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="supervisor_id" id="supervisor_id" class="form-control select2">
                                                    ...
                                                    @foreach($users as $u)
                                                        <option value="{{ $u->id }}" @if($company->supervisor_id == $u->id) selected @endif >{{ $u->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <button type="submit" id="save-form" style="max-width: 300px;"
