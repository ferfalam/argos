<div class="modal-header">
    ...
    <h4 class="modal-title">@lang('modules.projects.subtaskTitle')</h4>
</div>
    ...
    <div class="portlet-body">
        <div class="table-responsive">
            <table class="table category-table">
                ...
                <tr>
                    <th>#</th>
                    <th>@lang('modules.projects.subtaskTitle')</th>
...
<script>
    ...
    $('body').on('click', '.delete-category', function(e) {
        ...
        var url = "{{ route('admin.sub-task-title.destroy',':id') }}";
    ...
    $('#createTaskCategoryForm').on('submit', (e) => {
        e.preventDefault();
        $.easyAjax({
            url: '{{route('admin.sub-task-title.store')}}',
        ...
        var url = "{{ route('admin.sub-task-title.update', ':id')}}";
        url = url.replace(':id', id);
        $.easyAjax({
            url: url,
