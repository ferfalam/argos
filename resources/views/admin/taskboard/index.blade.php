...
<x-main-header>
    ...
    <x-slot name="btns">
        ...
        {{-- <a href="javascript:;" id="createTaskCategory" class=" btn-sm small-info-btn"><i class="fa fa-plus"></i> @lang('modules.taskCategory.addTaskCategory')</a>
        <a href="javascript:;" id="add-task" class=" btn-sm small-success-btn"><i class="fa fa-plus"></i> @lang('app.task')</a> --}}
        <a href="javascript:;" id="add-column" class=" small-success-btn btn-sm"><i class="fa fa-plus"></i> @lang('modules.tasks.addBoardColumn')</a>
    </x-slot>
</x-main-header>
@endsection
...
<div class="row">
    <form action="" id="filter-form">
        ...
        @php
            $label1 = __('app.select') . __('app.client');
        @endphp
    
        <x-filter-form-group label="{{$label1}}">
        ...
        <x-filter-form-group :label="['app.select', 'modules.tasks.assignTo']">
        ...
        <x-filter-form-group :label="['app.select', 'modules.tasks.assignBy']">
        ...
        <x-filter-form-group label="modules.taskCategory.taskCategory">
        ...
        <x-filter-form-group :label="['app.select', 'app.label']">
        ...
        <x-filter-form-group :label="['app.select', 'app.milestone']">
...
@section('content')
<div class="panel panel-default row" id="add-column-form" style="display: none;">
    <div class="panel-body">        
        ...
        <div class="row" >
            ...
            <div class="col-xs-12">
                <div class="form-group">
                    <button class="btn btn-cs-green" id="save-form" type="submit"><i class="fa fa-check"></i> @lang('app.save')</button>
                </div>
            </div>
            <!--/span-->
