    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-inverse">
                <div class="panel-heading">@lang('app.consent')</div>
                        ...
                        <div class="col-sm-12">
                            <div class="row ">
                                <div class="col-xs-12">
                                    ...
                                    <button type="button" onclick="submitForm();" class="btn btn-cs-green">
                                        Submit
                                    </button>
                                    {!! Form::close() !!}

                                    <hr>
                                    <div class="d-flex p-b-10 justify-content-between">
                                        <h3 class="box-title m-b-0">@lang('modules.gdpr.purposeOfConsent')</h3>
                                        <p>
                                            <button type="button" id="addConsent" class="btn btn-cs-blue"><i
