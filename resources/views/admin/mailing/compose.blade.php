            ...
            <form action="http://localhost/SMS/communication/message_send" class="frm-submit-data"
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="message" id="message" rows="20" class="form-control summernote" style="height: 100px"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12 row">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="input-append " style="display: flex; align-items:center; justify-content:flex-start; gap:20px;">
                                    <div class="uneditable-input " style="margin-right: 30px">
                ...
                <div class="panel-footer" style="display: -webkit-box; padding: 20px 15px;">
