...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
            <a onclick="showAdd()" class="small-success-btn btn-sm m-l-5">@lang('modules.holiday.addNewHoliday') <i class="fa fa-plus" aria-hidden="true"></i></a>
...
@section('content')
    ...
    {{-- <div class=" panel-default" style="padding-left: 20px; padding-right: 20px"> --}}
        {{-- <div class="row">
            <div class="col-md-12 ">
