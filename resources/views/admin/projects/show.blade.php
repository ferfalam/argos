...
@section('page-title')
    ...
    <div class="col-lg-7 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title"> @lang('app.project') #{{ $project->id }} - {{ ucwords($project->project_name) }}</h4>
    </div>
    <br>
    <!-- /.page title -->
    <!-- .breadcrumb -->
...
<div class="row">
    <div class="col-xs-12">
        <div class="panel-container">
            <x-stat-card title="modules.projects.projectBudget" img="card-1.png" count="{{ !is_null($project->currency) ? $project->currency->currency_symbol.$project->project_budget : $project->project_budget }}"></x-stat-card>
            <x-stat-card title="app.earnings" img="card-2.png" count="{{ !is_null($project->currency) ? currency_formatter($earnings,$project->currency->currency_symbol) : currency_formatter($earnings,'') }}"></x-stat-card>
            ...
            <x-stat-card title="modules.projects.hoursLogged" img="card-3.png" count="{{ $hoursLogged }}">
                @if ($overTime != 0 && $overTime > 0)
                    <small class="text-danger font-12 pull-left" style="display:flex; align-items: center;" data-toggle="tooltip" data-original-title="@lang('modules.timeLogs.overtime')"><i class="fa fa-arrow-up"></i>{{$overTime}}</small>
                @endif
            </x-stat-card>

            <x-stat-card title="modules.projects.expenses_total" img="card-3.png" count="{{ !is_null($project->currency) ? currency_formatter($expenses,$project->currency->currency_symbol) : currency_formatter($expenses,'') }}"></x-stat-card>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="row m-t-10">
            <div class="col-md-6">
                <div class="panel ">
                    <div class="panel-heading">@lang('modules.projects.info')</div>
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body b-all border-radius">
                            <div class="row">
                                <div class="col-xs-6">
