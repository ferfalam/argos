...
@section('page-title')
    <div class="row bg-title" style="align-items: flex-start">
        <!-- .page title -->
        <div class="col-lg-6 col-md-6 col-sm-4 col-xs-12 bg-title-left">
            <h4 class="page-title">  @lang($pageTitle) #{{ $project->id }} - <span class="font-bold">{{ ucwords($project->project_name) }}</span></h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
...
@section('content')
    ...
    <div class="row m-b-30" style="display: none;" id="ticket-filters">
        <div class="col-xs-12">
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-default">
                <section id="section-line-3" class="show panel-body">
                    <div class="container-scroll" style="background-color: transparent;">
                        {{-- <button id="toggle_fullscreen" class="btn btn-default btn-outline btn-sm pull-right m-l-10"><i class="icon-size-fullscreen"></i></button>
                        ...
                        <div class="row container-row" style="width: 100%">
                        </div>
                    <!-- .row -->
                    </div>
                </section>
