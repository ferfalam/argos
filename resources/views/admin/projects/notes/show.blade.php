            ...
            <x-main-header>
                ...
                <x-slot name="btns">
                    <a href="javascript:;" id="show-add-form"
                       class="btn btn-success"><i class="ti-plus"></i> @lang('app.menu.notes')</a>
                </x-slot>
            </x-main-header>
        </div>
    </div>
        ...
        <div class="col-xs-12">
            ...
            <section id="section-line-3" class="show">
                <div class="table-responsive m-t-30">
                    <table
                        class="table dataTable table-bordered table-hover toggle-circle default footable-loaded footable"
                        id="contacts-table">
                        <thead>
                            <tr>
                                <th>@lang('app.id')</th>
