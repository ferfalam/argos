...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="white-box white-height">
                ...
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $languageSetting->language_name }}"
                                id="language_name" name="language_name" placeholder="Enter Language Name">
                        </div>
                        <div class="form-group">
                            <label for="language_code">@lang('app.language_code')</label>
                            <input type="text" class="form-control" value="{{ $languageSetting->language_code }}"
                                id="language_code" name="language_code" placeholder="Enter Language Code">
                        </div>
                        <div class="form-group ">
