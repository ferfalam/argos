                    ...
                    <div class="row">
                        <div class="col-sm-12 col-xs-12">
                            <a href="{{ route('super-admin.language-settings.create') }}"
                                class="btn btn-outline btn-success btn-sm m-b-30">@lang('app.add') @lang('app.language') <i
                                    class="fa fa-plus" aria-hidden="true"></i></a>
                            <a href="{{ url('/translations') }}" target="_blank" class="btn btn-sm m-b-30 btn-warning"><i
