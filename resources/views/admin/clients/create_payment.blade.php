                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group" >
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="input-icon">
                                    <input type="text" class="form-control due_date" name="due_date" id="invoice_date" value="{{$invoice->due_date ? Carbon\Carbon::parse($invoice->due_date)->format($global->date_format) : Carbon\Carbon::today()->format($global->date_format) }}">
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $('.save-form').click(function(e){
        ...
        var url = "{{route('admin.clients.payments.storePayment')}}";
