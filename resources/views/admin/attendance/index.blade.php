...
<x-main-header>
    ...
    <x-slot name="btns">
        <x-link type="link" url="{{ route('admin.attendances.create') }}" classes="btn btn-cs-blue" icon="fa fa-plus" title="modules.attendance.markAttendance"/>
    </x-slot>
</x-main-header>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group m-t-20">
                            <button type="button" id="apply-filter" class="small-success-btn btn-block">@lang('app.apply')</button>
                        </div>
                    </div>
