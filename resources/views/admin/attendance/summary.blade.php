...
<x-main-header>
    ...
    <x-slot name="btns">
        <x-link type="link" url="javascript:;" classes="btn btn-cs-blue bulk-attendance" title="modules.attendance.bulkAttendance"/>
        <x-link type="link" url="{{ route('admin.attendances.create') }}" classes="btn btn-cs-green" icon="fa fa-plus" title="modules.attendance.markAttendance"/>
    </x-slot>
</x-main-header>
@endsection
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="form-group m-t-25">
                    <button type="button" id="apply-filter" class="btn btn-inverse rounded-pill small-info-btn btn-block">@lang('app.apply')</button>
                </div>
            </div>
