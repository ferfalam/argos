...
@section('content')
    ...
    <x-tab-container title="app.menu.notes">

        <x-slot name="btns">
            <a href="javascript:;" id="show-add-form" class="btn btn-success btn-outline"> @lang('modules.notes.addNotes')</a>
        </x-slot>
        ...
        <div style="display: grid;">
            <div class="col-xs-12">
                ...
                {!! Form::hidden('supplier_detail_id', $supplierDetail->id) !!}
...
<script src="{{ asset('plugins/bower_components/custom-select/custom-select.min.js') }}"></script>
    ...
    <script>
        ...
        processing: true,
        serverSide: true,
        ajax: '{!! route('admin.suppliersNotes.data', $supplierDetail->id) !!}',
        deferRender: true,
        language: {
        ...
        columns: [
            ...
            $('#save-form').click(function () {
                $.easyAjax({
                    url: '{{route('admin.suppliersNotes.store')}}',
                    container: '#addNotes',
                    type: "POST",
                    redirect: true,
             ...
             $('body').on('click', '.edit-contact', function () {
                ...
                var url = '{{ route('admin.suppliersNotes.edit', ':id')}}';
            ...
            $('body').on('click', '.view-contact', function () {
                ...
                var url = '{{ route('admin.suppliersNotes.view', ':id')}}';
                url = url.replace(':id', id);
    ...
    $('body').on('click', '.sa-params', function(){
        ...
        swal({
            ...
            if (isConfirm) {
                var url = "{{ route('admin.suppliersNotes.destroy',':id') }}";
                url = url.replace(':id', id);
