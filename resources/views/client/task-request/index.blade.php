...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="bg-title-right">
            <a href="javascript:;" id="show-new-task-panel" class="btn btn-cs-green btn-outline btn-sm">
...
<style>
    ...
    #new-task-panel .form-body,
    #edit-task-panel .form-body{
        display: grid;
    }

    #new-task-panel .form-actions,
    #edit-task-panel .form-actions{
        margin-left: -7.5px;
        margin-right: -7.5px;
        margin-top: 30px;
    }
...
@section('content')
            ...
            <div class="white-box">
                <div class="tabs" style="margin-top: 0px;">
                    <div class ="tabs-header">
                        <a class="tab-btn {{ request()->routeIs('client.tasks.edit') ? 'active' : '' }}" href="{{ route('client.tasks.edit', $project->id) }}"><span>@lang('app.task')</span></a>
                        <a class="tab-btn {{ request()->routeIs('client.tasks-request.show') ? 'active' : ''}}" href="{{ route('client.tasks-request.show', $project->id) }}"><span>@lang('modules.tasks.requestTask')</span></a>
                    </div>
                </div>
    ...
    <div class="row"  id="task-list-panel">
        <div class="col-xs-12">
