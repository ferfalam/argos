    ...
    <li class="list-group-item">
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                &nbsp;&nbsp
                <a href="{{ route('client.files.download', $file->id) }}" data-toggle="tooltip" data-original-title="Download" class="btn btn-default btn-circle" style="padding: 0 6px !important;"><i class="fa fa-download"></i></a>
