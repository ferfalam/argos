    ...
    <ul class="list-unstyled components" >
        ...
        @if(in_array('invoices',$modules))
            <li class="{{request()->routeIs('client.invoices.index') ? 'active' : ''}}">
                <a href="{{ route('client.invoices.index') }}" class="waves-effect"><i class="ti-receipt fa-fw"></i> <span class="hide-menu">@lang('app.menu.invoices') </span> </a> 
            </li>
        @endif

        
        @if(in_array('estimates',$modules))
            <li class="{{request()->routeIs('client.estimates.index') ? 'active' : ''}}">
                <a href="{{ route('client.estimates.index') }}" class="waves-effect"><i class="icon-doc fa-fw"></i> <span class="hide-menu">@lang('app.menu.estimates') </span> </a> 
            </li>
        @endif
