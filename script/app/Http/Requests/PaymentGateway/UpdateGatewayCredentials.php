...
class UpdateGatewayCredentials extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'moncommercesitenumber' => 'required_if:mon_commerce_status,on',
            'moncommercerownumber' => 'required_if:mon_commerce_status,on',
            'moncommercehmackey' => 'required_if:mon_commerce_status,on',
            'moncommercesiteidentifier' => 'required_if:mon_commerce_status,on',
            'moncommerce_environment' => '',
        ];
    }
