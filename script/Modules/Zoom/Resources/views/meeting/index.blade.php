...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-5 col-sm-8 col-md-8 col-xs-12 text-right">
            ...
            <a href="{{ route('admin.offmeeting.calendar') }}" class="btn btn-outline btn-info btn-sm"><i class="fa fa-calendar" aria-hidden="true"></i> @lang('zoom::modules.zoommeeting.calendarView') </a>
            <ol class="breadcrumb">
