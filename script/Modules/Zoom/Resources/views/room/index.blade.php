    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-5 col-sm-8 col-md-8 col-xs-12 text-right">
            <a href="#" data-toggle="modal" data-target="#my-meeting" class="btn btn-sm btn-success btn-outline waves-effect waves-light">
                <i class="ti-plus"></i> @lang('zoom::modules.zoommeeting.addRoom')
            </a>
{{--            <a href="{{ route('admin.zoom-meeting.index') }}" class="btn btn-outline btn-info btn-sm"><i class="fa fa-calendar" aria-hidden="true"></i> @lang('zoom::modules.zoommeeting.calendarView')</a>--}}
            <ol class="breadcrumb">
