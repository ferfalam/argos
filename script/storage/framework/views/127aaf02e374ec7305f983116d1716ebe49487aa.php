...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            ...
            <p class="alert alert-info">For Domain:- <b><?php echo e(\request()->getHost()); ?></b></p>

            <p  class="alert alert-success">Product Link:-
                <a href="<?php echo e(config('froiden_envato.envato_product_url')); ?>" target="_blank"><?php echo e(config('froiden_envato.envato_product_url')); ?></a>
            </p>
...
<?php /**PATH C:\Users\Nirodya Gamage\Documents\worksuite-saas-3.9.7\script\resources\views/vendor/froiden-envato/verify_purchase.blade.php ENDPATH**/ ?>