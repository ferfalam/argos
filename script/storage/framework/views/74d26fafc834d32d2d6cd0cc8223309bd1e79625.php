...
<head>
    <meta charset="UTF-8">
    <title>Récupérer Mot de Passe | <?php echo e(ucwords($global->company_name)); ?></title>
                                            ...
                                            <div class="elementor-widget-container">
                                                <?php if(session('status')): ?>
                                                    <img width="557" height="702"
                                                         src="<?php echo e(asset('/umar/images/Illustration-2.png')); ?>"
                                                         class="attachment-full size-full" alt="" loading="lazy"
                                                         srcset="<?php echo e(asset('/umar/images/Illustration-2.png')); ?> 557w, <?php echo e(asset('/umar/images/Illustration-2.png')); ?> 238w"
                                                         sizes="(max-width: 557px) 100vw, 557px" />
                                                <?php else: ?>

                                                    <img width="557" height="702"
                                                         src="<?php echo e(asset('/umar/images/Group.png')); ?>"
                                                         class="attachment-full size-full" alt="" loading="lazy"
                                                         srcset="<?php echo e(asset('/umar/images/Group.png')); ?> 557w, <?php echo e(asset('/umar/images/Group.png')); ?> 238w"
                                                         sizes="(max-width: 557px) 100vw, 557px" />
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                            ...
                                            <div class="elementor-widget-container">
                                                ...
                                                <form class="form-horizontal form-material" method="POST"
                                                    ...
                                                    <?php if(session('status')): ?>
                                                        ...
                                                        <meta http-equiv="refresh" content="1; URL=<?php echo e(route('login')); ?>">

                                                    <?php else: ?>

                                                        <h3 class="box-title m-t-40 m-b-0">
                                                            Récupérer Mot de Passe
                                                        <!--<?php echo app('translator')->get('app.recoverPassword'); ?>-->
                                                        </h3>
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="col-xs-12">
                                                                ...
                                                                <!--<?php echo app('translator')->get('app.enterEmailInstruction'); ?>-->
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <!--<?php echo app('translator')->get('app.email'); ?>-->
                                                        ...
                                                        <div class="form-group text-center m-t-20">
                                                            <div class="col-xs-12">
                                                                ...
                                                                <!--<?php echo app('translator')->get('app.sendPasswordLink'); ?>-->
                                                                </button>
                                                            </div>
                                                        </div>
...
<?php /**PATH C:\Users\Nirodya Gamage\Documents\worksuite-saas-3.9.7\script\resources\views/auth/passwords/email.blade.php ENDPATH**/ ?>