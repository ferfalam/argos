            ...
            <div class="panel-body">
                ...
                <div class="list-group lg-alt">
                    <div class="list-group-item media">
                        ...
                        <div class="media-body">
                            <div class="widget-title"><a href="<?php echo e(route('super-admin.email-settings.index')); ?>"
                    ...
                    <div class="list-group-item media">
                        ...
                        <div class="media-body">
                            <div class="widget-title"><a
                                        href="<?php echo e(route('super-admin.settings.index')); ?>"><?php echo e(__('messages.installationStep3')); ?></a>
                            </div>
                ...
                <div class="list-group lg-alt">
                    <div class="list-group-item media">
                        ...
                        <div class="media-body">
                            <div class="widget-title"><a href="<?php echo e(route('super-admin.profile.index')); ?>"
...
<?php endif; ?><?php /**PATH C:\Users\Nirodya Gamage\Documents\worksuite-saas-3.9.7\script\resources\views/super-admin/dashboard/get_started.blade.php ENDPATH**/ ?>