...
<ul class="nav tabs-vertical">
    ...
    <li class="tab <?php if(\Illuminate\Support\Facades\Route::currentRouteName() == 'super-admin.payment-settings.index'): ?> active <?php endif; ?>">
        <a href="<?php echo e(route('super-admin.payment-settings.index')); ?>"><?php echo app('translator')->get('app.menu.onlinePayment'); ?></a></li>
...
<?php /**PATH C:\Users\Nirodya Gamage\Documents\worksuite-saas-3.9.7\script\resources\views/sections/super_admin_payment_setting_menu.blade.php ENDPATH**/ ?>