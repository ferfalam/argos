<form id="editSettings" class="ajax-form" data-language-id="<?php echo e($languageId); ?>">
    <?php echo csrf_field(); ?>
    <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="fileinput fileinput-new" data-provides="fileinput">
                        <div class="fileinput-new thumbnail"
                            ...
                            <img src="<?php echo e(asset('saas/img/home/home-crm.png')); ?>" alt=""/>
                        </div>
...
</form><?php /**PATH C:\Users\Nirodya Gamage\Documents\worksuite-saas-3.9.7\script\resources\views/super-admin/front-settings/new-theme/new-form.blade.php ENDPATH**/ ?>