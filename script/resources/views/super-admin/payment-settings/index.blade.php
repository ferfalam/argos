                                            ...
                                            <div class="form-body">
                                                <ul class="nav nav-tabs" role="tablist">
                                                    ...
                                                    <li class="nav-item">
                                                        ...
                                                        <span class="hidden-sm-up">
                                                             <img src="{{ asset('img/moncommerce.png') }}" width="25px" class="display-small">
                                                        </span>
                                                            <span class="hidden-xs-down">Mon Commerce @if($credentials->mon_commerce_status == 'active') <i class="fa fa-check-circle activated-gateway"></i> @endif</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                                ...
                                                <div class="tab-content tabcontent-border">
                                                    ...
                                                    <div class="tab-pane" id="mon_commerce" role="tabpanel">
                                                        <div class="col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="password" name="moncommercesitenumber" id="moncommercesitenumber"
                                                                       class="form-control" value="{{ $credentials->moncommercesitenumber }}">
                                                                <span class="fa fa-fw fa-eye field-icon toggle-password"></span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-xs-12">
                                                            <div class="form-group">
                                                                <label> @lang('modules.paymentSetting.moncommercerownumber')</label>
                                                                <input type="password" name="moncommercerownumber" id="moncommercerownumber"
                                                                       class="form-control" value="{{ $credentials->moncommercerownumber }}">
                                                                <span class="fa fa-fw fa-eye field-icon toggle-password"></span>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="password" name="moncommercehmackey" id="moncommercehmackey"
                                                                       class="form-control" value="{{ $credentials->moncommercehmackey }}">
                                                                <span class="fa fa-fw fa-eye field-icon toggle-password"></span>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="password" name="moncommercesiteidentifier" id="moncommercesiteidentifier"
                                                                       class="form-control" value="{{ $credentials->moncommercesiteidentifier }}">
                                                                <span class="fa fa-fw fa-eye field-icon toggle-password"></span>
                                                            </div>
                                                        ...
                                                        <div class="col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="moncommerce_environment" id="moncommerce_environment" data-style="form-control">
                                                                    <option value="sandbox" @if($credentials->moncommerce_environment == 'sandbox') selected @endif>Sandbox</option>
                                                                    <option value="live" @if($credentials->moncommerce_environment == 'live') selected @endif>Live</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="control-label" >@lang('modules.paymentSetting.moncommerceStatus')</label>
                                                                <div class="switchery-demo">
                                                                    <input type="checkbox" name="mon_commerce_status" @if($credentials->mon_commerce_status == 'active') checked @endif class="js-switch " data-color="#00c292" data-secondary-color="#f96262"  />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--/span-->
