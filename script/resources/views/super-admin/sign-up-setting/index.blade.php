                                ...
                                <div class="col-sm-12 col-xs-12">
                                  ...
                                  <div class="form-body">
                                    ...
                                    <div class="row register">
                                      ...
                                      <div class="col-md-4 disable-message @if($registrationStatus->registration_open == 1) hide-box @endif" >
                                        <div class="form-group">
                                            <div class="checkbox checkbox-info  col-md-10">
                                                <input id="enable_register" name="enable_register" value="1" 
                                                @if($registrationStatus->enable_register == true) checked
                                                @endif
                                                type="checkbox">
                                                <label for="enable_register">@lang('modules.accountSettings.enableRegister')</label>
                                            </div>
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="row disable-message hide-box">
                                        <div class="tab-content">
                                            <div id="vhome3" class="tab-pane active">
                                                <div class="row">
                                                    <input type ="hidden" name = "setting_id" id="setting_id" value={{$registrationStatus->id}}>
                                                    <div class="col-sm-12">
